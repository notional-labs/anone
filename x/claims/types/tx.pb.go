...
func (*MsgInitialClaim) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed0aafa2e7589bb8, []int{0}
}
...
func (*MsgInitialClaimResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed0aafa2e7589bb8, []int{1}
}
...
type MsgClaimFor struct {
	...
	Action  Action `protobuf:"varint,3,opt,name=action,proto3,enum=notionallabs.anone.claims.Action" json:"action,omitempty"`
}
...
func (*MsgClaimFor) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed0aafa2e7589bb8, []int{2}
}
...
func (*MsgClaimForResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed0aafa2e7589bb8, []int{3}
}
...
func init() {
	proto.RegisterType((*MsgInitialClaim)(nil), "notionallabs.anone.claims.MsgInitialClaim")
	proto.RegisterType((*MsgInitialClaimResponse)(nil), "notionallabs.anone.claims.MsgInitialClaimResponse")
	proto.RegisterType((*MsgClaimFor)(nil), "notionallabs.anone.claims.MsgClaimFor")
	proto.RegisterType((*MsgClaimForResponse)(nil), "notionallabs.anone.claims.MsgClaimForResponse")
}
...
var fileDescriptor_ed0aafa2e7589bb8 = []byte{
	...
	,
}
...
func (c *msgClient) InitialClaim(ctx context.Context, in *MsgInitialClaim, opts ...grpc.CallOption) (*MsgInitialClaimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/notionallabs.anone.claims.Msg/InitialClaim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimFor(ctx context.Context, in *MsgClaimFor, opts ...grpc.CallOption) (*MsgClaimForResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/notionallabs.anone.claims.Msg/ClaimFor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_InitialClaim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/notionallabs.anone.claims.Msg/InitialClaim",
	}
...
func _Msg_ClaimFor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/notionallabs.anone.claims.Msg/ClaimFor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
